...
class FMSJob(models.Model):
    ...
    job_line_ids = fields.One2many('fms.job.line', 'job_id',
                                   string='Job Lines')
    ...
    def _compute_totals(self):
        for job in self:
            ...
            job.margin_percent = (job.margin / job.total_price * 100) if job.total_price else 0
...
class FMSJobLine(models.Model):
    ...
    def _onchange_product_id(self):
        if self.product_id:
            ...
            # Auto-fill from rate card if exists
